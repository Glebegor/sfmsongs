			...
			layout.Rigid(
				func(gtx layout.Context) layout.Dimensions {
					return layout.Flex{
						...
						layout.Rigid(
							func(gtx layout.Context) layout.Dimensions {
								text := Player.GetName(musicArray[idOfMusicInDir])
								...
								return layout.Flex{Alignment: layout.Middle}.Layout(gtx,
									layout.Rigid(func(gtx layout.Context) layout.Dimensions {
										return layout.UniformInset(unit.Dp(18)).Layout(gtx,
											material.Body1(th, fmt.Sprintf("%.0f/%.0f", sliderLenOfMusic.Value, lenOfMusic)).Layout,
										)
									}),
								)
							},
				...
				func(gtx layout.Context) layout.Dimensions {
					return layout.Flex{
						...
						layout.Rigid(
							func(gtx layout.Context) layout.Dimensions {
								return layout.Flex{Alignment: layout.Middle}.Layout(gtx,
									layout.Flexed(1, material.Slider(th, &sliderLenOfMusic, 0, lenOfMusic).Layout))
							},
						),
					)
				},
				...
				func(gtx layout.Context) layout.Dimensions {
					return layout.Flex{
						...
						layout.Rigid(
							func(gtx layout.Context) layout.Dimensions {
								return layout.Flex{Alignment: layout.Middle}.Layout(gtx,
									layout.Flexed(1, material.Slider(th, &sliderSoundVol, 0, 1).Layout))
							},
						),
					)
				},
					...
					return layout.Flex{
						...
						layout.Rigid(
							func(gtx layout.Context) layout.Dimensions {
								...
								return margins.Layout(gtx,
									func(gtx layout.Context) layout.Dimensions {
										playPBtn := material.Button(th, &repeatButton, "Repeat")
						...
						layout.Rigid(
							func(gtx layout.Context) layout.Dimensions {
								...
								return margins.Layout(gtx,
									func(gtx layout.Context) layout.Dimensions {
										playPBtn := material.Button(th, &playAllPlaylistButton, "Play Playlist")
										return playPBtn.Layout(gtx)
									},
								)
							},
